...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-577b288435539738"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-577b288435539738",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-577b288435539738",
        "url": "https://en.wikipedia.org/wiki/McMullen_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The McMullen problem on projectively transforming sets of points into convex position",
      "version": 1
    },
    "title": "McMullen problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "505c0ff126c7ac02f8f577b68eb6e9d581c1c3ed6815bba63f0d9a57eed92de4"
}
```
